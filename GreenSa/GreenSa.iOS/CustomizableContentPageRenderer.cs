...
[assembly: ExportRenderer(typeof(CustomizableContentPage), typeof(CustomizableContentPage))]
namespace GreenSa.iOS
{
    class CustomizableContentPageRenderer : PageRenderer
    {
        public override void ViewWillAppear(bool animated)
        {
            base.ViewWillAppear(animated);

            if (((CustomizableContentPage)Element).EnableBackButtonOverride)
            {
                SetCustomBackButton();
            }
        }
        ...
        private void SetCustomBackButton()
        {
            ...
            backBtn.TouchDown += (sender, e) =>
            {
                ...
                if (((CustomizableContentPage)Element)?.
                CustomBackButtonAction != null)
                {
                    ((CustomizableContentPage)Element)?.
